...
2. Revisar si MySQL y Redis estan disponibles.
...
| Redis caido                            | BullMQ no puede coordinar jobs.                      | No ejecutar workers manuales en paralelo; restaurar Redis y readiness.    |
...
- p99;
- errores;
- observaciones del worker y queue lag.
