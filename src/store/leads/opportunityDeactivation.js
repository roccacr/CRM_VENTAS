 ...
 */
export const ensureLeadOpportunitiesAreInactive = async (leadId, options = {}) =>
    deactivateLeadOpportunities((currentLeadId) => inactivateOpportunitiesByLead(currentLeadId, options), leadId);
