...
export const AvanceDiferenciado = ({formValues, handleInputChange}) => {
  return (
      <>
          <div className="row" hidden={formValues.custbody75_estimacion === "7" ? false : true}>
              <div className="col-sm-3">
                  <label className="form-label">HITO 1 %</label>
                  <input
                      autoComplete="off"
                      type="text"
                      name="avance_diferenciado_hito11"
                      value={formValues.avance_diferenciado_hito11}
                  ...
                  <input
                      autoComplete="off"
                      type="text"
                      name="avance_diferenciado_hito1"
                      value={formValues.avance_diferenciado_hito1}
                      onChange={handleInputChange}
                      className={`form-control mb-2`}
                  />
                  <input
