...
export const tableColumns = [
    ...
    { title: "Lote (m2)", data: "loteM2_exp", className: "text-left" }, // 8
    { title: "Área de Parqueo (m2)", data: "areaDeParqueoAprox", className: "text-left" }, // 9
    { title: "Área de Bodega (m2)", data: "areaDeBodegaM2_exp", className: "text-left" }, // 10
    { title: "Área de Mezzanine (m2)", data: "areaDeMezzanieM2_exp", className: "text-left" }, // 11
    { title: "Área Común Libre (m2)", data: "areacomunLibe_exp", className: "text-left" }, // 12
    { title: "Precio de Venta Mínimo", data: "precioDeVentaMinimo", className: "text-left" }, // 13
];
