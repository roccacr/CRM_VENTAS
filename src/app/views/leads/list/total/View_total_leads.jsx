...
const Header = () => (
   <div className="card-header table-card-header">
      <div role="alert" className="fade alert alert-success show">
         Usted está en la vista de leads totales
      </div>
   </div>
);
...
const getDataTableConfig = (tableElement, inputStartDate, inputEndDate, filterOption, idnetsuite_admin, rol_admin) => {
   ...
   return {
      ajax: {
         url: `${apiUrlImg}leads/getAllLeadsTotal`,
         type: "POST",
         data: function (d) {
            return {
               ...commonRequestData,
      ...
      searchPanes: {
         ...
         viewTotal: true,
         columns: [0, 1, 3, 4, 5, 6, 7, 12, 13, 14],
      },
      processing: true,
      dom: "lPBfrtip",
      buttons: [
...
export default View_total_leads;
