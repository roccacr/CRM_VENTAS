...
/**
 * View_list_leads_Stragglers Component
 ...
 */
const View_list_leads_Stragglers = () => {
     ...
     return (
          <div className="card" style={{ width: "100%" }}>
               <div className="card-header table-card-header">
                    <h5>LISTA COMPLETA DE LEADS RESAGADOS</h5>
               </div>
               <FilterOptions
...
export default React.memo(View_list_leads_Stragglers);
