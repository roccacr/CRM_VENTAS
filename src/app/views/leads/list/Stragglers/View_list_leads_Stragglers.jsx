...
import { getLeadsAttention, getLeadStragglers } from "../../../../../store/leads/thunksLeads";
...
export default function View_list_leads_Stragglers() {
    ...
    const fetchData = async (startDate, endDate, filterOption) => {
        ...
        const result = await dispatch(getLeadStragglers(startDate, endDate, filterOption));
    ...
    return (
        <div className="card" style={{ width: "100%" }}>
            <div className="card-header table-card-header">
                <h5>MÓDULO DE LEADS REZAGADOS</h5>
            </div>
