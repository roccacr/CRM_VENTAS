...
const Header = () => (
   <div className="card-header table-card-header">
      <div role="alert" className="fade alert alert-success show">
         Usted está en la vista de leads con poco seguimiento
      </div>
   </div>
);
...
const getDataTableConfig = (tableElement, inputStartDate, inputEndDate, filterOption, idnetsuite_admin, rol_admin) => {
   ...
   return {
      ajax: {
         url: `${apiUrlImg}leads/SP_OBTENER_LEADS_PERDIDOS_MINIMO_SEGUIMIENTO_API`,
         type: "POST",
         data: function (d) {
            return {
               ...commonRequestData,
...
const PocoSeguimeinto = () => {
   ...
   /**  Estado para la opción de filtrado - solo fecha de creación */
   ...
   /**
    * Maneja el cambio de la opción de filtrado
    * @param {number} option - Opción seleccionada (solo 1 disponible)
    */
...
export default PocoSeguimeinto;
