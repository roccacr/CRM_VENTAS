...
export const NavBar = ({ sidebarVisible, sidebarStatus, closeSidebar }) => {
  ...
  const className = sidebarVisible
    ? sidebarStatus === "mobile-active"
          ...
          <ul className="pc-navbar" style={{ display: "block" }}>
            ...
            <li className="pc-item">
              <NavLink to="/Movies/list" className="pc-link active">
                ...
                <span className="pc-mtext">Películas</span>
              </NavLink>
            </li>
            {rol_user == 1 ? (
              <>
                ...
                <li className="pc-item">
                  <NavLink to="/Bugs/edit" className="pc-link">
                    <span className="pc-micon">
                ...
                <li className="pc-item">
                  <NavLink to="/Bugs/list" className="pc-link">
                    <span className="pc-micon">
                      <i className="ph-duotone ph-bug"></i>
                    </span>
                    <span className="pc-mtext">Control de Bug</span>
                  </NavLink>
                </li>
              </>
            ) : null}
          ...
          <div className="card pc-user-card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                <div className="avtar avtar-s btn-light-success">
                  <i className="ph-duotone ph-buildings f-22"></i>
                </div>
                <div className="flex-grow-1 ms-3 me-2">
                  <h6 className="mb-0">name_use</h6>
