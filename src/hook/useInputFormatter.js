...
export const calculoContraEntregaSinprimaTotal = (
    ...
    setValoresFormulario((valoresPrevios) => ({
        ...
        date_hito_6: valoresPrevios.date_hito_6 || valoresPrevios.custbody114, // Usa la fecha del hito 6 o la fecha de entrega si no está definida.
    }));
};
...
export const calculoContraEntregaMontoCalculado = (
    ...
    setValoresFormulario((valoresPrevios) => ({
        ...
        date_hito_6: valoresPrevios.date_hito_6 || valoresPrevios.custbody114,
    }));
};
...
export const calculoHito1Diferenciado = (
    ...
    // Limpia y convierte el monto total a un número flotante válido
    const montoTotalCalculado = cleanAndParseFloat(updatedValues.custbody163);
