    ...
    const routesConfig = [
...

        {
            ...
            routes: [
                ...
                { path: "/oportunidad/getOpportunityTraceability", method: "getOpportunityTraceability" }, // Retrieve opportunity traceability snapshot and history
        ...
        },
        {
            ...
            routes: [
                ...
                { path: "/sticknotes/eliminar", method: "eliminarSticNote" }, // Eliminar sticky note
            ],
        },
    ];
