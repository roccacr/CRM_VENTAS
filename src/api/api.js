...
const apiUrl = window.location.hostname === "localhost" ? "http://localhost:7000/api/v2.0/" : "https://showtime.rdghub.com/api/v2.0/";

// Define la URL base de la API para imágenes
const apiUrlImg = window.location.hostname === "localhost" ? "http://localhost:7000/api/v2.0/" : "https://showtime.rdghub.com";
