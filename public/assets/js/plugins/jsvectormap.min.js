!(function (t, e) {
  ...
  var k = {
    ...
    M = function (t, e, i) {
      ...
      return (
        ...
        { type: a, code: r, event: o, element: n ? t.regions[r].element : t._markers[r].element, tooltipText: n ? t._mapData.paths[r].name || '' : t._markers[r].config.name || '' }
      );
    };
  var x = (function () {
      function t() {}
      ...
      function i(t) {
        ...
        if (o && c) {
          ...
          (i.labelX = u.x + u.width / 2 + p[0]),
            ...
            (i.label = i._map.canvas.createText({ text: c, textAnchor: 'middle', alignmentBaseline: 'central', dataCode: a, x: i.labelX, y: i.labelY }, h, l)),
  ...
  var L = (function (e) {
    function i(t) {
      var i,
        ...
        c = t.group,
        u = t.config;
      return ((i = e.call(this) || this).config = u), (i.shape = a.canvas.createLine({ x1: r, y1: o, x2: h, y2: l, dataIndex: s }, n, c)), i.shape.addClass('jvm-line'), i;
    }
    return (
      t(i, e),
    ...
    return (
      ...
      (s._createLabel = function (t) {
        ...
        (this._labelX = n / i.scale - i.transX),
          ...
          (this.label = i.canvas.createText({ text: l, dataIndex: e, x: this._labelX, y: this._labelY, dy: '0.6ex' }, i.params.markerLabelStyle, a)),
  ...
  var T = {
        ...
        var t,
          ...
          h = function (h) {
            ...
            if (('touchstart' == h.type && (r = 0), 1 == d.length))
              1 == r &&
                ((u = o.transX), (p = o.transY), (o.transX -= (i - d[0].pageX) / o.scale), (o.transY -= (s - d[0].pageY) / o.scale), o._tooltip.hide(), o._applyTransform(), (u == o.transX && p == o.transY) || h.preventDefault()),
                (i = d[0].pageX),
                (s = d[0].pageY);
            else if (2 == d.length)
      ...
      _createLines: function (t, e, i) {
        ...
        for (var n in ((this.linesGroup = this.linesGroup || this.canvas.createGroup('jvm-lines-group')), t)) {
          ...
          !1 !== s &&
            !1 !== a &&
            (this._lines[_(r.from, r.to)] = new L({ index: n, map: this, style: v({ initial: this.params.lineStyle }, { initial: r.style || {} }, !0), x1: s.x, y1: s.y, x2: a.x, y2: a.y, group: this.linesGroup, config: r }));
        }
      },
      ...
      _setScale: function (t, e, i, s, a) {
        ...
        t > this.params.zoomMax * this._baseScale ? (t = this.params.zoomMax * this._baseScale) : t < this.params.zoomMin * this._baseScale && (t = this.params.zoomMin * this._baseScale),
          ...
          a && v > 0
            ...
            : ((this.transX = d), (this.transY = f), (this.scale = t), this._applyTransform(), this._emit(k.onViewportChange, [this.scale, this.transX, this.transY]));
      },
      setFocus: function (t) {
        var e = this;
        void 0 === t && (t = {});
          ...
          return (
            s.forEach(function (t) {
              if (e.regions[t]) {
                ...
                s &&
                  (i = void 0 === i ? s : { x: Math.min(i.x, s.x), y: Math.min(i.y, s.y), width: Math.max(i.x + i.width, s.x + s.width) - Math.min(i.x, s.x), height: Math.max(i.y + i.height, s.y + s.height) - Math.min(i.y, s.y) });
              }
            }),
      ...
      getMarkerPosition: function (t) {
        var e = t.coords;
        return G.maps[this.params.map].projection ? this.coordsToPoint.apply(this, e) : { x: e[0] * this.scale + this.transX * this.scale, y: e[1] * this.scale + this.transY * this.scale };
      },
          ...
          S.on(this._map.container, 'mousemove', function (e) {
            if (t._tooltip.classList.contains('active')) {
              var i,
                ...
                l = e.pageY - r - 5,
                c = e.pageX - o - 5;
              h && ((l += r + 5), (c -= 10)), e.clientX < a.left + o + 5 && ((c = e.pageX + 5 + 2), h && (c += 10)), t.css({ top: l + 'px', left: c + 'px' });
            }
          });
        }),
    ...
    // Verifica si this.container es null antes de acceder a su propiedad classList
    if (this.container !== null) {
        ...
        console.error("Container element not found with selector: " + t.selector);
    }
}),
        ...
        (e.addLine = function (t, e, i) {
          void 0 === i && (i = {}), console.warn('`addLine` method is deprecated, please use `addLines` instead.'), this._createLines([{ from: t, to: e, style: i }], this._markers, !0);
        }),
  ...
  (G.maps = {}),
    (G.defaults = {
      ...
      markerStyle: { initial: { r: 7, fill: '#374151', fillOpacity: 1, stroke: '#FFF', strokeWidth: 5, strokeOpacity: 0.5 }, hover: { fill: '#3cc0ff', cursor: 'pointer' }, selected: { fill: 'blue' }, selectedHover: {} },
      markerLabelStyle: { initial: { fontFamily: 'Verdana', fontSize: 12, fontWeight: 500, cursor: 'default', fill: '#374151' }, hover: { cursor: 'pointer' }, selected: {}, selectedHover: {} },
      regionsSelectable: !1,
      regionsSelectableOne: !1,
      regionStyle: { initial: { fill: '#dee2e8', fillOpacity: 1, stroke: 'none', strokeWidth: 0 }, hover: { fillOpacity: 0.7, cursor: 'pointer' }, selected: { fill: '#9ca3af' }, selectedHover: {} },
